...
public class RouterTest {
    ...
    void echoRouteTest() throws IOException {
        var instance = Router.route(parse("GET /echo/aaa HTTP/1.1\r\n\r\n\r\n"));
    ...
    void filesGetRouteTest() throws IOException{
        var instance = Router.route(parse("GET /files/dawd HTTP/1.1\r\n\r\n\r\n"));
    ...
    void filesPostRouteTest() throws IOException{
        var instance = Router.route(parse("POST /files/gafw HTTP/1.1\r\n\r\n\r\n"));
    ...
    void userAgentRouteTest() throws IOException{
        var instance = Router.route(parse("GET /user-agent HTTP/1.1\r\n\r\n\r\n"));
    ...
    void notFoundRouteTest() throws IOException{
        var instance = Router.route(parse("GET /fafw HTTP/1.1\r\n\r\n\r\n"));
